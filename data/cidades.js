...
export const conteudos = {
        ...
        <>
            <div className="container mt-4">
                <div className="schedule-card">
                    ...
                    <span className="description"> Abertura com Diretor Regional da Inspetoria, Coordenador da COR, Presidente do CREA-SC e Diretor da Mútua</span>
                </div>
                <div className="schedule-card">
                    <strong className="time">19:00</strong>
                    <span className="description"> Apresentação dos eixos temáticos</span>
                </div>
                <div className="schedule-card">
                    <strong className="time">20:00</strong>
                    <span className="description">Divisão em grupos de trabalho</span>
                </div>
                <div className="schedule-card">
                    <strong className="time">21:00</strong>
                    <span className="description">Plenária para aprovação das propostas e moções</span>
                </div>
                <div className="schedule-card">
                    <strong className="time">22:00</strong>
                    <span className="description">Eleição dos delegados para o CEP</span>
                </div>
                <div className="schedule-card">
                    <strong className="time">23:00</strong>
                    <span className="description">Encerramento</span>
                </div>
            </div>
        </>
    ...
    // Continue com as outras cidades aqui...
};
