      ...
      <div className="container py-5">
        <div className="row align-items-center">
          <div className="col-md-8">
            ...
            <a href="https://ipsbrasil.org.br/pt/explore/scorecard/4200051" target="_blank" rel="noopener noreferrer">
              <button>
                Confira os indicadores do seu município <FaChevronRight />
              </button>
            </a>
          </div>
